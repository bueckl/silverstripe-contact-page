...
class ContactForm extends BootstrapAjaxForm {
	...
	function __construct($controller, $name) {
		...
		$fields = new FieldList(
			TextField::create("Name")->addExtraClass('span4')->setTitle(_t("ContactForm.NAME", "Nombre")),
			EmailField::create("Email")->addExtraClass('span4')->setTitle(_t("ContactForm.EMAIL", "Email")),
